            ...
            <section className="inner-section">
                <div className="single-certificate">
                    ...
                    <div className="right-section">
                        ...
                        <div className="see-credential">
                            <a href="https://www.credential.net/18457136-9200-4402-838e-36821609d847">See Credential</a>
                        </div>
                    </div>
                </div>
                <div className="single-certificate">
                ...
                <div className="single-certificate">
                    ...
                    <div className="right-section">
                        ...
                        <div className="see-credential">
                            <a href="https://certificates.mooc.fi/validate/now5f43e5od">See Credential</a>
                        </div>
                    </div>
                </div>
            </section>
